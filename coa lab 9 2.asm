ORG 100h ; Display the message "Enter a single-digit number: " 
MOV DX, OFFSET msg_input 
MOV AH, 09h 
INT 21h ; Read the digit from the user 
MOV AH, 01h 
INT 21h ; Check if the digit is between 0 and 9 
...
JZ even_number ; If result is 0, it's even ; Display message for odd 
...
end_program: 
MOV AH, 4Ch 
INT 21h ; Data section with messages 
